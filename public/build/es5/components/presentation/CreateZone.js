        ...
        render: {
            value: function render() {
                return React.createElement(
                    "div",
                    null,
                    React.createElement("input", { onChange: this.updateZone.bind(this), className: "form-control", type: "text", id: "name", placeholder: "Name" }),
                    React.createElement("input", { onChange: this.updateZone.bind(this), className: "form-control", type: "text", id: "zipCode", placeholder: "Zip Code" }),
